...
const MainLoader = () => {
  return (
    <div className="w-full min-h-screen absolute top-0 left-0 bg-white flex flex-col gap-2 items-center justify-center z-50 ">
      ...
      <span className="w-14 h-14 inline-flex border-8 border-borderColor border-t-borderColor border-l-borderColor rounded-full relative ">
      ...
      <p className="text-lg text-center font-semibold tracking-wide text-themeColor">Loading...</p>
    </div>
  );
};
